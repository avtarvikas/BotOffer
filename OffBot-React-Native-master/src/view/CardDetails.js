  ...
  renderRowItem = ({ item }) => {
    return (
      <View
        ...
        onPress={() => window.location("www.youtube.com")}
      >
        <Image
          style={{ height: 86, width: equalWidth }}
          source={{ uri: item.url }}
          resizeMode="cover"
        />
      </View>
    ...
    return (
      <Container style={styles.container}>
        <Grid>
          ...
          <Row>
            <Grid>
              <Row style={{ height: 260 }}>{image_content}</Row>
              <Row
                style={
                ...
                <Grid>
                  ...
                  >
                    <Grid>
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "0" })}
                          style={{
                      ...
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "1" })}
                        >
                          <Text
                            style={
                      ...
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "2" })}
                        >
                          <Text
                            style={
                              this.state.activeWindow == "2"
                      ...
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "3" })}
                  ...
                  >
                    <Grid>
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "4" })}
                          style={{ borderTopRightRadius: 5 }}
                        >
                          <Text
                            style={
                              this.state.activeWindow == "4"
                                ? styles.tabactivetext
                                : styles.tabtext
                            }
                          >
                      ...
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "5" })}
                          style={{ borderTopRightRadius: 5 }}
                        >
                          <Text
                            style={
                              this.state.activeWindow == "5"
                                ? styles.tabactivetext
                                : styles.tabtext
                            }
                          >
                      ...
                      <Col>
                        <TouchableHighlight
                          underlayColor="rgb(2,139,141)"
                          onPress={() => this.setState({ activeWindow: "6" })}
                          style={{ borderTopRightRadius: 5 }}
                        >
                          <Text
                            style={
                              this.state.activeWindow == "6"
                                ? styles.tabactivetext
                                : styles.tabtext
                            }
                          >
                  ...
                  {this.state.activeWindow == "0" ? (
                    <Row>
                      <Grid>
                        <Row>
                          <View
                            style={{ flex: 1, marginLeft: 19, marginRight: 25 }}
                          >
                            <Text
                              style={{
                                fontSize: 30,
                  ...
                  {this.state.activeWindow == "1" ? (
                    <Row>
                      <Grid>
                        <Row>
                          <View
                            style={{ flex: 1, marginLeft: 15, marginRight: 16 }}
                          >
                            <View
                              style={{
                                height: 156,
                            ...
                            >
                              Lorem Imspum Bar elit. Sed gravida dolor nec
                              tortor condimentum, et tincidunt arcu eleifend.
                            </Text>
                            <Text
                              style={{
                                marginTop: 30,
                        ...
                        <Row>
                          <View style={{ height: 200, flex: 1 }}>
                            <WebView
                              style={{ marginTop: 20 }}
                              source={{
                                uri: "https://www.youtube.com/embed/u9Mv98Gr5pY"
                              }}
                              javaScriptEnabled={true}
                              domStorageEnabled={true}
                            />
                            {/* <Video url="https://www.youtube.com/embed/A71aqufiNtQ" /> */}
                            {/* <VideoPlayer
                              source={{
                                uri: "https://www.youtube.com/embed/u9Mv98Gr5pY"
                              }}
                            ...
                            <Col style={{ width: 165 }}>
                              ...
                              >
                                <LinearGradient
                                  ...
                                  style={styles.linearGradient_share}
                                >
                                  {/* <Button block onPress={() => this.props.navigation.navigate("DrawerOpen")} style={{ marginTop: 10, backgroundColor: '#0B9496', height: 50, width: 50, borderRadius: 25, marginLeft: 10 }}>
                          <Feather name='menu' size={35} color="#FFFFFF" />
                        </Button> */}
                                  <Entypo
                                    ...
                                    size={40}
                                    color="#FFFFFF"
                                    style={{ marginLeft: 64, marginTop: 12 }}
                                  />
                                </LinearGradient>
                              </TouchableHighlight>
                            </Col>
                          ...
                          >
                            ...
                            >
                              ...
                              {this.props.details.end_date
                                ? moment(this.props.details.end_date).format(
                      ...
                      <Grid>
                        <Row>
                          ...
                          >
                            ...
                            >
                              This offer is a {this.props.details.pricing} and
                              it is {this.props.details.original_price} for{" "}
                              {this.props.details.sale_price}
                            </Text>
                          </View>
                        </Row>
                        <Row style={{ height: 104 }}>
